...
| `get-app-icon` | `node_modules/node-mac-app-icon/run` | [sallar/GetAppIcon](https://github.com/sallar/GetAppIcon) (MIT) |
...
The build needs Xcode or the Xcode command line tools. `get-app-icon` and `audio-devices` fetch their Swift package dependencies from GitHub on the first build.
